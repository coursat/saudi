                    ...
                    <div class="uk-navbar-right">
                        ...
                        <div class="header-widget">
                                ...
                                <div class="dropdown-notifications-content" data-simplebar>
                                    ...
                                    <ul>
                                        <li class="notifications-not-read">
                                            <a href="course-intro.html">
                                                <span class="notification-image">
                                                    <img src="{{url('/')}}/assets/images/course/1.png" alt=""> </span>
                                        ...
                                        <li>
                                            <a href="course-intro.html">
                                                <span class="notification-image">
                                                    <img src="{{url('/')}}/assets/images/course/3.png" alt=""> </span>
                                                <span class="notification-text">
                                        ...
                                        <li>
                                            <a href="course-intro.html">
                                                <span class="notification-image">
                                                    <img src="{{url('/')}}/assets/images/course/2.png" alt=""> </span>
                                                <span class="notification-text">
                                ...
                                <div class="dropdown-notifications-content" data-simplebar>
                                    ...
                                    <ul>
                                        <li class="notifications-not-read">
                                            <a href="#">
                                                <span class="notification-avatar">
                                                    <img src="{{url('/')}}/assets/images/avatars/avatar-2.jpg" alt="">
                                                </span>
                                                <div class="notification-text notification-msg-text">
                                                    <strong>Jonathan Madano</strong>
                                                    <p>Okay{{url('/')}} Thanks for The Answer I will be waiting for your{{url('/')}}.
                                                    </p>
                                        ...
                                        <li>
                                            <a href="#">
                                                <span class="notification-avatar">
                                                    <img src="{{url('/')}}/assets/images/avatars/avatar-3.jpg" alt="">
                                                </span>
                                                <div class="notification-text notification-msg-text">
                                        ...
                                        <li>
                                            <a href="#">
                                                <span class="notification-avatar">
                                                    <img src="{{url('/')}}/assets/images/avatars/avatar-1.jpg" alt="">
                                                </span>
                                                <div class="notification-text notification-msg-text">
                                                    <strong>Alex Dolgove</strong>
                                                    <p> Alia Joseph just joined Messenger! Be the first to send a
                                                        welcome message{{url('/')}}</p>
                                        ...
                                        <li>
                                            <a href="#">
                                                <span class="notification-avatar">
                                                    <img src="{{url('/')}}/assets/images/avatars/avatar-4.jpg" alt="">
                                                </span>
                                                <div class="notification-text notification-msg-text">
                            ...
                            <a href="#" class="header-widget-icon profile-icon">
                                <img src="{{url('/')}}/assets/images/avatars/avatar-2.jpg" alt="" class="header-profile-icon">
                            </a>
        ...
        <div class="nav-overlay uk-navbar-left uk-position-relative uk-flex-1 bg-grey uk-light p-2" hidden
            ...
            <div class="uk-navbar-item uk-width-expand" style="min-height: 60px;">
                <form class="uk-search uk-search-navbar uk-width-1-1">
                    <input class="uk-search-input" type="search" placeholder="Search{{url('/')}}." autofocus>
                </form>
            </div>
...
.button {
                    ...
                    <div uk-sticky>
                        ...
                        <ul class="uk-switcher uk-overflow-hidden">
                            ...
                            <li>
                                ...
                                <img src="{{url('/')}}/assets/images/course/8.png" alt="">
                                <div class="p-3">
	...
	==============================================-->
    <script type="text/javascript" src="{{url('/')}}/assets/syntax-highlighter/scripts/shCore.js"></script>
    <script type="text/javascript" src="{{url('/')}}/assets/syntax-highlighter/scripts/shBrushJScript.js"></script>
    <script type="text/javascript" src="{{url('/')}}/assets/syntax-highlighter/scripts/shBrushXml.js"></script>
